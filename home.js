...
function modale(event){
    ...
    fetch("http://151.97.9.184/cannata_alessio/hw1/like_users.php?idPost=" + boxPost.id).then(onResponseLikeUsers).then(onJSONLikeUsers);
}
...
function aggiungiLike(event){
    ...
    fetch("http://151.97.9.184/cannata_alessio/hw1/metti_like.php?idPost=" + boxPost.id).then(onResponseAddLike).then(onJSONAddLike);
}
...
function onJSON(json)
{
    ...
    for(post of json){
        ...
        fetch("http://151.97.9.184/cannata_alessio/hw1/stampa_like.php?idPost=" + post.idPost).then(onResponseLike).then(onJSONLike);
...
fetch("http://151.97.9.184/cannata_alessio/hw1/utenti_seguiti.php").then(onResponse).then(onJSON);